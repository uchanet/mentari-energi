			...
			<div class="col-md-5 col-sm-5 col-12">
				<div class="dots-bg mt-40">
					<div class="section-heading text-left">
						...
						<h3 class="semi-bold">Knowing more about business, consumers and society.</h3>
...
<div class="container-fluid pl-0 pr-0">
	<div class="row no-gutters">
		<div class="col-md-6 col-sm-12 col-12">
			<div class="full-background background-right min-350" style="background-image: url(<?= site_url() ?>assets/base/img/content/home-images/dream.jpg);"></div>
		</div>
		<div class="col-md-6 col-sm-12 col-12">
