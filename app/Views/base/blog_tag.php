			...
			<div class="row">
				<div class="col-md-9 col-sm-12 col-12">
					<div class="section-heading text-left" style="margin-bottom:45px">
						<h4 class="semi-bold text-uppercase">Tag : <?=$this->request->uri->getSegment(3)?></h4>
					...
					<?php
						...
						use App\Models\Post;
						$post = new Post();
						$result = $post->where('active', 'Y')->like('tag', $uri)->orderBy('created', 'ASC')->paginate(5, 'bootstrap');
						$pager = $post->where('active', 'Y')->like('tag', $uri)->orderBy('created', 'ASC')->pager;
						if (empty($result)){
							echo "Empty...";
						} else {
