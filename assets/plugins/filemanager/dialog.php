...
<html>
    <head>
        ...
        <link rel="stylesheet" href="libs/jplayer/skin/blue.monday/jplayer.blue.monday.min.css" />
        <link rel="stylesheet" href="libs/tui/tui-image-editor.css">
        ...
        <script src="libs/jplayer/js/jquery.jplayer.min.js"></script>
        <link type="text/css" href="libs/tui/tui-color-picker.css" rel="stylesheet">
        <script type="text/javascript" src="libs/fabric.js/fabric.js"></script>
        <script type="text/javascript" src="libs/tui/tui-code-snippet.min.js"></script>
        <script type="text/javascript" src="libs/FileSaver.js/FileSaver.min.js"></script>
        <script type="text/javascript" src="libs/tui/tui-color-picker.js"></script>
        <script src="libs/tui/tui-image-editor.js"></script>
