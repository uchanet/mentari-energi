...
$config = array(
    ...
    |
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'].preg_replace('#/+#','/', "/".str_replace("assets/plugins/filemanager/dialog.php", "", $_SERVER['PHP_SELF'])."/"),
    /*
    |--------------------------------------------------------------------------
